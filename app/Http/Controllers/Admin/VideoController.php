...
class VideoController extends Controller
{
    ...
    {
        $videos = Vidio::latest()->when(request()->q, function($videos) {
     ...
     * @return \Illuminate\Http\Response
     */
    public function edit(Vidio $video)
    {
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(Request $request, Vidio $video)
    {
        $this->validate($request, [
            'title' => 'required',
            'embed' => 'required'
        ...
        $video = Vidio::findOrFail($video->id);
        $video->update([
            'title' => $request->input('title'),
            'embed' => $request->input('embed')
        ]);
