...
<head>
    ...
    <link rel="shortcut icon" href="{{asset('/landing-user/image/SMK Salafiyah (1)-min.png')}}" type="image/x-icon">
    <!-- General CSS Files -->
        ...
        <div class="main-wrapper main-wrapper-1">
            ...
            <div class="main-sidebar sidebar-style-2">
                <aside id="sidebar-wrapper">
                    <div class="sidebar-brand">
                        <img src="{{ asset('/landing-user/image/SMK Salafiyah (1)-min.png') }}" width="60"
                            height="60" />
                        <a href="index.html">SMK SALAFIYAH</a>
                    </div>
            ...
            <footer class="main-footer">
                <div class="footer-left">
                    Copyright &copy; 2024 <div class="bullet"></div> HacaDeveloper <div class="bullet"></div> All
                    Rights
                    Reserved.
                </div>
